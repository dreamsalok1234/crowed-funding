...
export class RootauthService {
    ...
    signUpService(formdata) {   
       var headers = new Headers({'Content-Type':  'application/json','Access-Control-Allow-Origin': '*', 'Access-Control-Allow-Credentials':true,'Access-Control-Allow-Methods': 'GET, POST, PUT, DELETE','Access-Control-Allow-Headers':'Origin, X-Re'Access-Control-Allow-Origin':'http://18.191.133.127:4200'});
